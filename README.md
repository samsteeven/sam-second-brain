...
1. **Qdrant** : `docker compose -f infrastructure/docker/docker-compose.yml up -d`
2. **Obsidian** : ouvrir le vault `sam-second-brain-vault/` et suivre la structure dans `obsidian/README.md`.
3. **n8n** : importer les workflows (voir `n8n/workflows/README.md`), configurer la credential **OpenAI**.
